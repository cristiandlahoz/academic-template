...
Feng et al. \cite{feng2021its} documentan que sistemas modernos de tutoría basados en EMT (Expectation-Misconception Tailoring, un marco pedagógico que adapta la instrucción según las expectativas y misconcepciones del estudiante) ``que utilizan diálogo para andamiaje funcionan tan bien como tutores humanos en temas STEM (Science, Technology, Engineering, and Mathematics)'', con tamaños de efecto d=1.0 (donde d representa la diferencia estandarizada entre grupos de control y experimentales; d=1.0 indica una mejora de una desviación estándar completa, considerado un efecto muy grande) comparables a tutoría humana individual.
...
\begin{itemize}
    \item Módulos 1, 2, 3: Diálogo socrático con guardrails
    \item Módulo 5: Panel básico de instructor
    \item Módulo 6: Base de conocimiento para 3-4 algoritmos fundamentales
    \item Módulo 7: Prompts metacognitivos básicos
\end{itemize}
...
\begin{itemize}
    \item Viabilidad técnica de ITS basados en LLMs
    \item Necesidad urgente de guardrails pedagógicos
    \item Efectividad del marco EMT para STEM
    \item Peligro real de pereza metacognitiva con IA generativa
    \item Ventaja de propiedad institucional vs. herramientas comerciales
\end{itemize}
